...
public class Predictions01 {

	public static void main(String[] args) throws Exception{
		//load dataset 
		ArffLoader loadsf = new ArffLoader();
		File f = new File("/Users/aminas/Desktop/MAMS/STEM/stem1_editedDatasets/datasetEditedv3_02-12-2021/stem1_dataset-01_MODEL-FINAL.arff");
		loadsf.setSource(f);
		...
		//load new dataset 
			...
			File j = new File("/Users/aminas/Desktop/MAMS/STEM/stem1_editedDatasets/datasetEditedv3_02-12-2021/stem1_dataset-01_TEST-FINAL.arff");
			loadsj.setSource(j);
		...
		*/
		...
		System.out.println();
	     ...
	     File csvFile = new File ("/Users/aminas/Desktop/MAMS/STEM/stem1_rawData/stem1_rawData_v2_02-12-2021/stem1_rawData01-FINAL.csv");
