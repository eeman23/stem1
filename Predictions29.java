/*
 * ended up not working because data was missing
 */
...
public class Predictions29 {

	public static void main(String[] args) throws Exception{
		//load dataset 
		ArffLoader loadsf = new ArffLoader();
		File f = new File("/Users/aminas/Desktop/MAMS/STEM/datasetEditedv2_02-12-2021/stem1_dataset-29_MODEL-FINAL.arff");
		loadsf.setSource(f);
		...
		//load dataset 
			...
			File j = new File("/Users/aminas/Desktop/MAMS/STEM/datasetEditedv2_02-12-2021/stem1_dataset-29_TEST-FINAL.arff");
			loadsj.setSource(j);
		...
		*/
		...
		System.out.println();
	     ...
	     File csvFile = new File ("/Users/aminas/Desktop/MAMS/STEM/stem1_rawData/stem1_rawDataResults0129.csv");
